      ...
      ${s.diagnostics.length===0?'<p class="quiet">No engine diagnostics.</p>':`<ul class="diagnostic-list">${s.diagnostics.map(o=>`
                  <li${a?` data-diagnostic-state="${o.category==="unsupported"?"unsupported":"invalid"}"`:""}>
                    ...
                    <ul class="diagnostic-locations" aria-label="Diagnostic locations">
                      ${o.locations.map(c=>`<li>${$t(Ox(c))}</li>`).join("")}
                    </ul>
...
void main() {
	...
	`}class wh extends Tn{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new gh(s),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Ys(5,5,5),r=new Cn({name:"CubemapFromEquirect",uniforms:ds(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:qt,blending:kn});r.uniforms.tEquirect.value=n;const a=new pn(s,r),o=n.minFilter;return n.minFilter===vi&&(n.minFilter=Ut),new uy(1,10,this).update(e,a),n.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,n=!0,i=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(n,i,s);e.setRenderTarget(r)}}function cb(t){let e=new WeakMap,n=new WeakMap,i=null;function s(d,f=!1){return d==null?null:f?a(d):r(d)}function r(d){if(d&&d.isTexture){const f=d.mapping;if(f===Ta||f===wa)if(e.has(d)){const p=e.get(d).texture;return o(p,d.mapping)}else{const p=d.image;if(p&&p.height>0){const _=new wh(p.height);return _.fromEquirectangularTexture(t,d),e.set(d,_),d.addEventListener("dispose",l),o(_.texture,d.mapping)}else return null}}return d}function a(d){if(d&&d.isTexture){const f=d.mapping,p=f===Ta||f===wa,_=f===Ti||f===os;if(p||_){let m=n.get(d);const g=m!==void 0?m.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==g)return i===null&&(i=new Ud(t)),m=p?i.fromEquirectangular(d,m):i.fromCubemap(d,m),m.texture.pmremVersion=d.pmremVersion,n.set(d,m),m.texture;if(m!==void 0)return m.texture;{const A=d.image;return p&&A&&A.height>0||_&&A&&c(A)?(i===null&&(i=new Ud(t)),m=p?i.fromEquirectangular(d):i.fromCubemap(d),m.texture.pmremVersion=d.pmremVersion,n.set(d,m),d.addEventListener("dispose",h),m.texture):null}}}return d}function o(d,f){return f===Ta?d.mapping=Ti:f===wa&&(d.mapping=os),d}function c(d){let f=0;const p=6;for(let _=0;_<p;_++)d[_]!==void 0&&f++;return f===p}function l(d){const f=d.target;f.removeEventListener("dispose",l);const p=e.get(f);p!==void 0&&(e.delete(f),p.dispose())}function h(d){const f=d.target;f.removeEventListener("dispose",h);const p=n.get(f);p!==void 0&&(n.delete(f),p.dispose())}function u(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:u}}function lb(t){const e={};function n(i){if(e[i]!==void 0)return e[i];const s=t.getExtension(i);return e[i]=s,s}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const s=n(i);return s===null&&ss("WebGLRenderer: "+i+" extension not supported."),s}}}function db(t,e,n,i){const s={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const p in d.attributes)e.remove(d.attributes[p]);d.removeEventListener("dispose",a),delete s[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,n.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,n.memory.geometries++),d}function c(u){const d=u.attributes;for(const f in d)e.update(d[f],t.ARRAY_BUFFER)}function l(u){const d=[],f=u.index,p=u.attributes.position;let _=0;if(p===void 0)return;if(f!==null){const A=f.array;_=f.version;for(let w=0,v=A.length;w<v;w+=3){const E=A[w+0],y=A[w+1],T=A[w+2];d.push(E,y,y,T,T,E)}}else{const A=p.array;_=p.version;for(let w=0,v=A.length/3-1;w<v;w+=3){const E=w+0,y=w+1,T=w+2;d.push(E,y,y,T,T,E)}}const m=new(p.count>=65535?fh:hh)(d,1);m.version=_;const g=r.get(u);g&&e.remove(g),r.set(u,m)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&l(u)}else l(u);return r.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function ub(t,e,n){let i;function s(u){i=u}let r,a;function o(u){r=u.type,a=u.bytesPerElement}function c(u,d){t.drawElements(i,d,r,u*a),n.update(d,i,1)}function l(u,d,f){f!==0&&(t.drawElementsInstanced(i,d,r,u*a,f),n.update(d,i,f))}function h(u,d,f){if(f===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,r,u,0,f);let _=0;for(let m=0;m<f;m++)_+=d[m];n.update(_,i,1)}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=h}function hb(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,o){switch(n.calls++,a){case t.TRIANGLES:n.triangles+=o*(r/3);break;case t.LINES:n.lines+=o*(r/2);break;case t.LINE_STRIP:n.lines+=o*(r-1);break;case t.LINE_LOOP:n.lines+=o*r;break;case t.POINTS:n.points+=o*r;break;default:qe("WebGLInfo: Unknown draw mode:",a);break}}function s(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:s,update:i}}function fb(t,e,n){const i=new WeakMap,s=new dt;function r(a,o,c){const l=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=i.get(o);if(d===void 0||d.count!==u){let b=function(){T.dispose(),i.delete(o),o.removeEventListener("dispose",b)};d!==void 0&&d.texture.dispose();const f=o.morphAttributes.position!==void 0,p=o.morphAttributes.normal!==void 0,_=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],g=o.morphAttributes.normal||[],A=o.morphAttributes.color||[];let w=0;f===!0&&(w=1),p===!0&&(w=2),_===!0&&(w=3);let v=o.attributes.position.count*w,E=1;v>e.maxTextureSize&&(E=Math.ceil(v/e.maxTextureSize),v=e.maxTextureSize);const y=new Float32Array(v*E*4*u),T=new lh(y,v,E,u);T.type=En,T.needsUpdate=!0;const M=w*4;for(let P=0;P<u;P++){const C=m[P],I=g[P],X=A[P],H=v*E*4*P;for(let D=0;D<C.count;D++){const $=D*M;f===!0&&(s.fromBufferAttribute(C,D),y[H+$+0]=s.x,y[H+$+1]=s.y,y[H+$+2]=s.z,y[H+$+3]=0),p===!0&&(s.fromBufferAttribute(I,D),y[H+$+4]=s.x,y[H+$+5]=s.y,y[H+$+6]=s.z,y[H+$+7]=0),_===!0&&(s.fromBufferAttribute(X,D),y[H+$+8]=s.x,y[H+$+9]=s.y,y[H+$+10]=s.z,y[H+$+11]=X.itemSize===4?s.w:1)}}d={count:u,texture:T,size:new Fe(v,E)},i.set(o,d),o.addEventListener("dispose",b)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(t,"morphTexture",a.morphTexture,n);else{let f=0;for(let _=0;_<l.length;_++)f+=l[_];const p=o.morphTargetsRelative?1:1-f;c.getUniforms().setValue(t,"morphTargetBaseInfluence",p),c.getUniforms().setValue(t,"morphTargetInfluences",l)}c.getUniforms().setValue(t,"morphTargetsTexture",d.texture,n),c.getUniforms().setValue(t,"morphTargetsTextureSize",d.size)}return{update:r}}function pb(t,e,n,i,s){let r=new WeakMap;function a(l){const h=s.render.frame,u=l.geometry,d=e.get(l,u);if(r.get(d)!==h&&(e.update(d),r.set(d,h)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),r.get(l)!==h&&(n.update(l.instanceMatrix,t.ARRAY_BUFFER),l.instanceColor!==null&&n.update(l.instanceColor,t.ARRAY_BUFFER),r.set(l,h))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==h&&(f.update(),r.set(f,h))}return d}function o(){r=new WeakMap}function c(l){const h=l.target;h.removeEventListener("dispose",c),i.releaseStatesOfObject(h),n.remove(h.instanceMatrix),h.instanceColor!==null&&n.remove(h.instanceColor)}return{update:a,dispose:o}}const mb={[Xu]:"LINEAR_TONE_MAPPING",[qu]:"REINHARD_TONE_MAPPING",[Yu]:"CINEON_TONE_MAPPING",[Ku]:"ACES_FILMIC_TONE_MAPPING",[Ju]:"AGX_TONE_MAPPING",[ju]:"NEUTRAL_TONE_MAPPING",[Zu]:"CUSTOM_TONE_MAPPING"};function gb(t,e,n,i,s,r){const a=new Tn(e,n,{type:t,depthBuffer:s,stencilBuffer:r,samples:i?4:0,depthTexture:s?new cs(e,n):void 0}),o=new Tn(e,n,{type:Vn,depthBuffer:!1,stencilBuffer:!1}),c=new zt;c.setAttribute("position",new Vt([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new Vt([0,2,0,0,2,0],2));const l=new sy({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new pn(c,l),u=new zc(-1,1,1,-1,0,1);let d=null,f=null,p=!1,_,m=null,g=[],A=!1;this.setSize=function(w,v){a.setSize(w,v),o.setSize(w,v);for(let E=0;E<g.length;E++){const y=g[E];y.setSize&&y.setSize(w,v)}},this.setEffects=function(w){g=w,A=g.length>0&&g[0].isRenderPass===!0;const v=a.width,E=a.height;for(let y=0;y<g.length;y++){const T=g[y];T.setSize&&T.setSize(v,E)}},this.begin=function(w,v){if(p||w.toneMapping===An&&g.length===0)return!1;if(m=v,v!==null){const E=v.width,y=v.height;(a.width!==E||a.height!==y)&&this.setSize(E,y)}return A===!1&&w.setRenderTarget(a),_=w.toneMapping,w.toneMapping=An,!0},this.hasRenderPass=function(){return A},this.end=function(w,v){w.toneMapping=_,p=!0;let E=a,y=o;for(let T=0;T<g.length;T++){const M=g[T];if(M.enabled!==!1&&(M.render(w,y,E,v),M.needsSwap!==!1)){const b=E;E=y,y=b}}if(d!==w.outputColorSpace||f!==w.toneMapping){d=w.outputColorSpace,f=w.toneMapping,l.defines={},$e.getTransfer(d)===je&&(l.defines.SRGB_TRANSFER="");const T=mb[f];T&&(l.defines[T]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=E.texture,w.setRenderTarget(m),w.render(h,u),m=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),c.dispose(),l.dispose()}}const Rh=new Bt,hc=new cs(1,1),Ch=new lh,Ph=new gM,Ih=new gh,Vd=[],zd=[],Hd=new Float32Array(16),Gd=new Float32Array(9),Wd=new Float32Array(4);function ps(t,e,n){const i=t[0];if(i<=0||i>0)return t;const s=e*n;let r=Vd[s];if(r===void 0&&(r=new Float32Array(s),Vd[s]=r),e!==0){i.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=n,t[a].toArray(r,o)}return r}function bt(t,e){if(t.length!==e.length)return!1;for(let n=0,i=t.length;n<i;n++)if(t[n]!==e[n])return!1;return!0}function At(t,e){for(let n=0,i=e.length;n<i;n++)t[n]=e[n]}function xa(t,e){let n=zd[e];n===void 0&&(n=new Int32Array(e),zd[e]=n);for(let i=0;i!==e;++i)n[i]=t.allocateTextureUnit();return n}function _b(t,e){const n=this.cache;n[0]!==e&&(t.uniform1f(this.addr,e),n[0]=e)}function xb(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2f(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(bt(n,e))return;t.uniform2fv(this.addr,e),At(n,e)}}function vb(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3f(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else if(e.r!==void 0)(n[0]!==e.r||n[1]!==e.g||n[2]!==e.b)&&(t.uniform3f(this.addr,e.r,e.g,e.b),n[0]=e.r,n[1]=e.g,n[2]=e.b);else{if(bt(n,e))return;t.uniform3fv(this.addr,e),At(n,e)}}function Mb(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4f(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(bt(n,e))return;t.uniform4fv(this.addr,e),At(n,e)}}function yb(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(bt(n,e))return;t.uniformMatrix2fv(this.addr,!1,e),At(n,e)}else{if(bt(n,i))return;Wd.set(i),t.uniformMatrix2fv(this.addr,!1,Wd),At(n,i)}}function Sb(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(bt(n,e))return;t.uniformMatrix3fv(this.addr,!1,e),At(n,e)}else{if(bt(n,i))return;Gd.set(i),t.uniformMatrix3fv(this.addr,!1,Gd),At(n,i)}}function Eb(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(bt(n,e))return;t.uniformMatrix4fv(this.addr,!1,e),At(n,e)}else{if(bt(n,i))return;Hd.set(i),t.uniformMatrix4fv(this.addr,!1,Hd),At(n,i)}}function bb(t,e){const n=this.cache;n[0]!==e&&(t.uniform1i(this.addr,e),n[0]=e)}function Ab(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2i(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(bt(n,e))return;t.uniform2iv(this.addr,e),At(n,e)}}function Tb(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3i(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(bt(n,e))return;t.uniform3iv(this.addr,e),At(n,e)}}function wb(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4i(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(bt(n,e))return;t.uniform4iv(this.addr,e),At(n,e)}}function Rb(t,e){const n=this.cache;n[0]!==e&&(t.uniform1ui(this.addr,e),n[0]=e)}function Cb(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2ui(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(bt(n,e))return;t.uniform2uiv(this.addr,e),At(n,e)}}function Pb(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3ui(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(bt(n,e))return;t.uniform3uiv(this.addr,e),At(n,e)}}function Ib(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4ui(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(bt(n,e))return;t.uniform4uiv(this.addr,e),At(n,e)}}function Lb(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s);let r;this.type===t.SAMPLER_2D_SHADOW?(hc.compareFunction=n.isReversedDepthBuffer()?Fc:Nc,r=hc):r=Rh,n.setTexture2D(e||r,s)}function Db(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTexture3D(e||Ph,s)}function Nb(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTextureCube(e||Ih,s)}function Fb(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTexture2DArray(e||Ch,s)}function Ub(t){switch(t){case 5126:return _b;case 35664:return xb;case 35665:return vb;case 35666:return Mb;case 35674:return yb;case 35675:return Sb;case 35676:return Eb;case 5124:case 35670:return bb;case 35667:case 35671:return Ab;case 35668:case 35672:return Tb;case 35669:case 35673:return wb;case 5125:return Rb;case 36294:return Cb;case 36295:return Pb;case 36296:return Ib;case 35678:case 36198:case 36298:case 36306:case 35682:return Lb;case 35679:case 36299:case 36307:return Db;case 35680:case 36300:case 36308:case 36293:return Nb;case 36289:case 36303:case 36311:case 36292:return Fb}}function Ob(t,e){t.uniform1fv(this.addr,e)}function kb(t,e){const n=ps(e,this.size,2);t.uniform2fv(this.addr,n)}function Bb(t,e){const n=ps(e,this.size,3);t.uniform3fv(this.addr,n)}function Vb(t,e){const n=ps(e,this.size,4);t.uniform4fv(this.addr,n)}function zb(t,e){const n=ps(e,this.size,4);t.uniformMatrix2fv(this.addr,!1,n)}function Hb(t,e){const n=ps(e,this.size,9);t.uniformMatrix3fv(this.addr,!1,n)}function Gb(t,e){const n=ps(e,this.size,16);t.uniformMatrix4fv(this.addr,!1,n)}function Wb(t,e){t.uniform1iv(this.addr,e)}function $b(t,e){t.uniform2iv(this.addr,e)}function Xb(t,e){t.uniform3iv(this.addr,e)}function qb(t,e){t.uniform4iv(this.addr,e)}function Yb(t,e){t.uniform1uiv(this.addr,e)}function Kb(t,e){t.uniform2uiv(this.addr,e)}function Zb(t,e){t.uniform3uiv(this.addr,e)}function Jb(t,e){t.uniform4uiv(this.addr,e)}function jb(t,e,n){const i=this.cache,s=e.length,r=xa(n,s);bt(i,r)||(t.uniform1iv(this.addr,r),At(i,r));let a;this.type===t.SAMPLER_2D_SHADOW?a=hc:a=Rh;for(let o=0;o!==s;++o)n.setTexture2D(e[o]||a,r[o])}function Qb(t,e,n){const i=this.cache,s=e.length,r=xa(n,s);bt(i,r)||(t.uniform1iv(this.addr,r),At(i,r));for(let a=0;a!==s;++a)n.setTexture3D(e[a]||Ph,r[a])}function eA(t,e,n){const i=this.cache,s=e.length,r=xa(n,s);bt(i,r)||(t.uniform1iv(this.addr,r),At(i,r));for(let a=0;a!==s;++a)n.setTextureCube(e[a]||Ih,r[a])}function tA(t,e,n){const i=this.cache,s=e.length,r=xa(n,s);bt(i,r)||(t.uniform1iv(this.addr,r),At(i,r));for(let a=0;a!==s;++a)n.setTexture2DArray(e[a]||Ch,r[a])}function nA(t){switch(t){case 5126:return Ob;case 35664:return kb;case 35665:return Bb;case 35666:return Vb;case 35674:return zb;case 35675:return Hb;case 35676:return Gb;case 5124:case 35670:return Wb;case 35667:case 35671:return $b;case 35668:case 35672:return Xb;case 35669:case 35673:return qb;case 5125:return Yb;case 36294:return Kb;case 36295:return Zb;case 36296:return Jb;case 35678:case 36198:case 36298:case 36306:case 35682:return jb;case 35679:case 36299:case 36307:return Qb;case 35680:case 36300:case 36308:case 36293:return eA;case 36289:case 36303:case 36311:case 36292:return tA}}class iA{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.setValue=Ub(n.type)}}class sA{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=nA(n.type)}}class rA{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,n,i){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,n[o.id],i)}}}const io=/(\w+)(\])?(\[|\.)?/g;function $d(t,e){t.seq.push(e),t.map[e.id]=e}function aA(t,e,n){const i=t.name,s=i.length;for(io.lastIndex=0;;){const r=io.exec(i),a=io.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){$d(n,l===void 0?new iA(o,t,e):new sA(o,t,e));break}else{let u=n.map[o];u===void 0&&(u=new rA(o),$d(n,u)),n=u}}}class Wr{constructor(e,n){this.seq=[],this.map={};const i=e.getProgramParameter(n,e.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){const o=e.getActiveUniform(n,a),c=e.getUniformLocation(n,o.name);aA(o,c,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,n,i,s){const r=this.map[n];r!==void 0&&r.setValue(e,i,s)}setOptional(e,n,i){const s=n[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,n,i,s){for(let r=0,a=n.length;r!==a;++r){const o=n[r],c=i[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,n){const i=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in n&&i.push(a)}return i}}function Xd(t,e,n){const i=t.createShader(e);return t.shaderSource(i,n),t.compileShader(i),i}const oA=37297;let cA=0;function lA(t,e){const n=t.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,n.length);for(let a=s;a<r;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${n[a]}`)}return i.join(`
`)}const qd=new Ue;function dA(t){$e._getMatrix(qd,$e.workingColorSpace,t);const e=`mat3( ${qd.elements.map(n=>n.toFixed(4))} )`;switch($e.getTransfer(t)){case ra:return[e,"LinearTransferOETF"];case je:return[e,"sRGBTransferOETF"];default:return Le("WebGLProgram: Unsupported color space: ",t),[e,"LinearTransferOETF"]}}function Yd(t,e,n){const i=t.getShaderParameter(e,t.COMPILE_STATUS),r=(t.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return n.toUpperCase()+`

`+r+`

`+lA(t.getShaderSource(e),o)}else return r}function uA(t,e){const n=dA(e);return[`vec4 ${t}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,"}"].join(`
`)}const hA={[Xu]:"Linear",[qu]:"Reinhard",[Yu]:"Cineon",[Ku]:"ACESFilmic",[Ju]:"AgX",[ju]:"Neutral",[Zu]:"Custom"};function fA(t,e){const n=hA[e];return n===void 0?(Le("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Dr=new U;function pA(){$e.getLuminanceCoefficients(Dr);const t=Dr.x.toFixed(4),e=Dr.y.toFixed(4),n=Dr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
`)}function mA(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",t.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Fs).join(`
`)}function gA(t){const e=[];for(const n in t){const i=t[n];i!==!1&&e.push("#define "+n+" "+i)}return e.join(`
`)}function _A(t,e){const n={},i=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=t.getActiveAttrib(e,s),a=r.name;let o=1;r.type===t.FLOAT_MAT2&&(o=2),r.type===t.FLOAT_MAT3&&(o=3),r.type===t.FLOAT_MAT4&&(o=4),n[a]={type:r.type,location:t.getAttribLocation(e,a),locationSize:o}}return n}function Fs(t){return t!==""}function Kd(t,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return t.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Zd(t,e){return t.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const xA=/^[ \t]*#include +<([\w\d./]+)>/gm;function fc(t){return t.replace(xA,MA)}const vA=new Map;function MA(t,e){let n=Be[e];if(n===void 0){const i=vA.get(e);if(i!==void 0)n=Be[i],Le('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return fc(n)}const yA=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Jd(t){return t.replace(yA,SA)}function SA(t,e,n,i){let s="";for(let r=parseInt(e);r<parseInt(n);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function jd(t){let e=`precision ${t.precision} float;
...
#define LOW_PRECISION`),e}const EA={[kr]:"SHADOWMAP_TYPE_PCF",[Ls]:"SHADOWMAP_TYPE_VSM"};function bA(t){return EA[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const AA={[Ti]:"ENVMAP_TYPE_CUBE",[os]:"ENVMAP_TYPE_CUBE",[fa]:"ENVMAP_TYPE_CUBE_UV"};function TA(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":AA[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const wA={[os]:"ENVMAP_MODE_REFRACTION"};function RA(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":wA[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const CA={[$u]:"ENVMAP_BLENDING_MULTIPLY",[Nv]:"ENVMAP_BLENDING_MIX",[Fv]:"ENVMAP_BLENDING_ADD"};function PA(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":CA[t.combine]||"ENVMAP_BLENDING_NONE"}function IA(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:i,maxMip:n}}function LA(t,e,n,i){const s=t.getContext(),r=n.defines;let a=n.vertexShader,o=n.fragmentShader;const c=bA(n),l=TA(n),h=RA(n),u=PA(n),d=IA(n),f=mA(n),p=gA(r),_=s.createProgram();let m,g,A=n.glslVersion?"#version "+n.glslVersion+`
...
<html>
  ...
  `;const e=Wt(t,".example-list"),n=Wt(t,".viewport-host"),i=Wt(t,".viewport-state"),s=Wt(t,".viewport-print"),r=Wt(t,".viewport-preview-label"),a=Wt(t,".stair-preview-label"),o=Wt(t,".stair-strategy-list"),c=Wt(t,".module-list"),l=Wt(t,".cutout-list"),h=Wt(t,".inspector-scroll"),u=Wt(t,".timeline-panel input[type='range']"),d=Wt(t,".timeline-panel output"),f=Wt(t,".timeline-markers"),p=Wt(t,".timeline-play"),_=[...t.querySelectorAll(".timeline-step")],m=IT(n),g=Rx();let A=0,w,v,E,y,T=0,M,b,P="Kirigami A4 fabrication template";const C=(j,G)=>{b=j,P=G??"Kirigami A4 fabrication template",s.disabled=j===void 0},I=()=>{M!==void 0&&window.clearInterval(M),M=void 0,p.ariaPressed="false",p.textContent="Play"},X=j=>j.points.length+j.segments.length+j.faces.length>0,H=(j,G)=>{const he=new Map;if(j.result.observed.disposition!=="accepted")for(const de of j.result.diagnostics)for(const ye of de.locations){if(ye.kind!=="sample")continue;const we=de.category==="unsupported"?"unsupported":"invalid";(we==="invalid"||he.get(ye.index)===void 0)&&he.set(ye.index,we)}const ne=Math.max(G-1,...he.keys(),0);f.replaceChildren(...[...he.entries()].map(([de,ye])=>{const we=document.createElement("span");return we.dataset.diagnosticState=ye,we.style.left=`${ne===0?0:de/ne*100}%`,we.title=`${ye} at sample ${de+1}`,we.setAttribute("role","img"),we.setAttribute("aria-label",we.title),we}))},D=(j,G=!1)=>{const he=v?.frames??w?.frames.map(we=>we.frame)??[],ne=v?.parameters??w?.frames.map(we=>we.parameter)??[];if(he.length===0)return;T=Math.max(0,Math.min(j,he.length-1));const de=he[T];a.hidden=!v,r.hidden=!0,delete r.dataset.diagnosticState,m.show(de),G&&m.focus(),u.max=String(he.length-1),u.value=String(T);const ye=he.length>1;u.disabled=!ye,p.disabled=!ye;for(const we of _)we.disabled=!ye;w&&!v&&H(w,he.length),d.value=`sample ${T+1}/${he.length} · parameter ${qT(ne[T]??0)}`},$=j=>{T=0,u.value="0",u.max="0",u.disabled=!0,p.disabled=!0;for(const G of _)G.disabled=!0;d.value=j?"no renderable samples · previous geometry retained":"no engine samples"},B=j=>{i.hidden=j===void 0,i.textContent=j??""},q=j=>{Ux(h,w,j,{onParameterCommit(G,he){if(!y)return;const ne=Px(y,G,he);if(!ne.ok){q(ne.diagnostics[0]?.message);return}y=ne.example,te(ne.example,{preserveGeometryOnEmpty:!0,focus:!1})},onReset(){E&&(y=E,te(E,{preserveGeometryOnEmpty:!0,focus:!1}))}})},te=async(j,G)=>{I();const he=++A;B(`Evaluating ${j.id}…`);try{const ne=await g.evaluate(j);if(he!==A)return;w=ne,y=ne.example,T=0,q(),ne.frames.some(({frame:ye})=>X(ye))?(C(ne.frames.find(({frame:ye})=>X(ye))?.frame,`${ne.example.title} — A4 fabrication template`),D(0,G.focus)):ne.diagnosticPreview!==void 0&&!G.preserveGeometryOnEmpty?(m.show(ne.diagnosticPreview.frame,{diagnostics:ne.result.diagnostics,disposition:ne.result.observed.disposition}),G.focus&&m.focus(),r.hidden=!1,r.dataset.diagnosticState=ne.result.observed.disposition==="rejected"?"invalid":"unsupported",r.textContent=`${ne.diagnosticPreview.label} · ${ne.result.observed.disposition}`,$(!1),H(ne,0),d.value=`${ne.diagnosticPreview.label} · no certified engine samples`):(G.preserveGeometryOnEmpty||C(),G.preserveGeometryOnEmpty||(m.show(lu),G.focus&&m.focus()),r.hidden=!1,r.dataset.diagnosticState=ne.result.observed.disposition==="rejected"?"invalid":"unsupported",r.textContent=G.preserveGeometryOnEmpty?`${ne.result.observed.disposition} input · previous certified geometry retained`:`${ne.result.observed.disposition} · no spatial preview`,$(G.preserveGeometryOnEmpty),H(ne,0)),B()}catch(ne){if(he!==A)return;const de=ne instanceof Error?ne.message:String(ne);q(de),B(`Engine error · ${de}`)}},re=j=>{const G=sr[j];if(G){for(const[he,ne]of[...e.querySelectorAll(".example-row")].entries())ne.ariaPressed=String(he===j);E=G.example,y=G.example,v=void 0,C(),a.hidden=!0,te(G.example,{preserveGeometryOnEmpty:!1,focus:!0})}},ce=()=>{I(),A+=1,w=void 0,r.hidden=!0,a.hidden=!1;const j={operationId:"certified-one-sheet-stair",hostPlane:"wall",...Ur},G=mc(j);if(!G.ok){h.textContent=G.diagnostics[0]?.message??"Stair rejected.";return}const he=_c({input:j,complex:G.complex,sourceMap:G.sourceMap,sampleCount:7});if(!he.ok){h.textContent=he.diagnostics[0]?.message??"Stair path rejected.";return}a.textContent="certified compiler result · One-sheet staircase";const ne=he.samples.map(de=>Bx(G.complex,G.sourceMap,j,de.transforms));v={frames:ne,parameters:he.samples.map(de=>de.parameter)},C(ne[0],"One-sheet staircase — A4 fabrication template"),m.show(ne.at(-1)),m.focus(),h.innerHTML=`
    ...
    `,D(ne.length-1)},ae=document.createElement("button");ae.type="button",ae.className="stair-strategy-button",ae.ariaPressed="false",ae.textContent="One-sheet staircase",ae.addEventListener("click",()=>{ae.ariaPressed="true",ce()}),o.append(ae);const ze=document.createElement("button");ze.type="button",ze.className="stair-strategy-button",ze.ariaPressed="false",ze.textContent="Tread-only staircase",ze.addEventListener("click",()=>{I(),A+=1,w=void 0,r.hidden=!0,a.hidden=!1;const j={operationId:"tread-only-stair",...Ur},G=Ac(j);if(!G.ok){h.textContent=G.diagnostics[0]?.message??"Tread-only pattern rejected.";return}const he=Tc({input:j,complex:G.complex,sourceMap:G.sourceMap,sampleCount:7});if(!he.ok){h.textContent=he.diagnostics[0]?.message??"Tread-only deployment rejected.";return}const ne=he.samples.map(ye=>ye.parameter),de=he.samples.map(ye=>Vx(G.complex,G.sourceMap,ye.transforms));v={frames:de,parameters:ne},C(de[0],"Tread-only staircase — A4 fabrication template"),m.show(de.at(-1)),m.focus(),a.textContent="compiler construction preview · Tread-only staircase",h.innerHTML=`
      <section class="inspection-section">
    ...
    `,D(de.length-1)}),o.append(ze);const Ze=document.createElement("button");Ze.type="button",Ze.className="stair-strategy-button",Ze.ariaPressed="false",Ze.textContent="Riser-only staircase",Ze.addEventListener("click",()=>{I(),A+=1,w=void 0,r.hidden=!0,a.hidden=!1;const j={operationId:"riser-only-stair",...Ur},G=Kx(j);if(!G.ok){h.textContent=G.diagnostics[0]?.message??"Riser-only pattern rejected.";return}const he=Zx({input:j,complex:G.complex,sourceMap:G.sourceMap,sampleCount:7});if(!he.ok){h.textContent=he.diagnostics[0]?.message??"Riser-only deployment rejected.";return}const ne=he.samples.map(ye=>ye.parameter),de=he.samples.map(ye=>zx(G.complex,G.sourceMap,ye.transforms));v={frames:de,parameters:ne},C(de[0],"Riser-only staircase — A4 fabrication template"),m.show(de.at(-1)),m.focus(),a.textContent="compiler construction preview · Riser-only staircase",h.innerHTML=`
      <section class="inspection-section">
    ...
    `,D(de.length-1)}),o.append(Ze);const He=document.createElement("button");He.type="button",He.className="stair-strategy-button",He.ariaPressed="false",He.textContent="Carrier-hosted compound staircase",He.addEventListener("click",()=>{I(),A+=1,w=void 0,r.hidden=!0,a.hidden=!1;const j=ev({operationId:"carrier-hosted-compound-stair",parent:Ur,child:{width:.16,stepCount:4,stepRun:.144,stepRise:.144,hostWidth:.24,hostFloorExtent:.72,hostWallExtent:.72},childHostStepIndex:6});if(!j.ok){h.textContent=j.diagnostics[0]?.message??"Compound stair rejected.";return}const G=tv({compilation:j,sampleCount:7});if(!G.ok){h.textContent=G.diagnostics[0]?.message??"Compound deployment rejected.";return}const he=G.samples.map(de=>de.parameter),ne=G.samples.map(de=>Hx(j,de));v={frames:ne,parameters:he},C(ne[0],"Carrier-hosted compound staircase — A4 fabrication template"),m.show(ne.at(-1)),m.focus(),a.textContent="compiler construction preview · Carrier-hosted compound staircase",h.innerHTML=`
      <section class="inspection-section">
    ...
    `,he.addEventListener("click",()=>re(j)),e.append(he)}return u.addEventListener("input",()=>{a.hidden=!0,I(),D(Number(u.value))}),_.forEach(j=>{j.addEventListener("click",()=>{I(),D(T+Number(j.dataset.direction))})}),p.addEventListener("click",()=>{if(M!==void 0){I();return}const j=v?.frames.length??w?.frames.length??0;j<=1||(T>=j-1&&D(0),p.ariaPressed="true",p.textContent="Pause",M=window.setInterval(()=>{const G=v?.frames.length??w?.frames.length??0;if(G===0||T>=G-1){I();return}D(T+1)},650))}),q(),re(0),()=>{A+=1,I(),g.dispose(),m.dispose(),t.replaceChildren()}}function Wt(t,e){const n=t.querySelector(e);if(!n)throw new Error(`Missing Engine Lab element: ${e}.`);return n}function qT(t){return Math.abs(t)>=1e3||t!==0&&Math.abs(t)<.001?t.toExponential(5):t.toFixed(5).replace(/0+$/,"").replace(/\.$/,"")}function Rs(t){return t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[e])}const Fh=document.querySelector("#app");if(!Fh)throw new Error("Missing Engine Lab root.");XT(Fh);
