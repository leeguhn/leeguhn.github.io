(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const rc=1,ac="hinge-flat",oc="Flat canonical hinge",lc="boundary",cc="single-hinge",hc="meter-radian",uc=["Ideal zero-thickness rigid faces"],dc="docs/single-hinge-specification.md",fc=1e-12,pc="singleHinge",mc={assignment:"valley",angle:0},gc={ok:!0,childPoint:[2,0,0],classification:"certifiedRigidPath"},_c={schemaVersion:rc,id:ac,title:oc,fixtureClass:lc,mechanismFamily:cc,units:hc,assumptions:uc,provenance:dc,tolerance:fc,kind:pc,input:mc,expected:gc},xc=1,vc="hinge-intermediate",Mc="Intermediate canonical hinge",Sc="valid",Ec="single-hinge",yc="meter-radian",bc=["Ideal zero-thickness rigid faces"],Tc="docs/single-hinge-specification.md",Ac=1e-12,wc="singleHinge",Rc={assignment:"valley",angle:1.0471975511965976},Cc={ok:!0,childPoint:[1.5,0,-.8660254037844386],classification:"certifiedRigidPath"},Pc={schemaVersion:xc,id:vc,title:Mc,fixtureClass:Sc,mechanismFamily:Ec,units:yc,assumptions:bc,provenance:Tc,tolerance:Ac,kind:wc,input:Rc,expected:Cc},Dc=1,Lc="hinge-folded",Ic="Quarter-turn canonical hinge",Uc="valid",Nc="single-hinge",Fc="meter-radian",Oc=["Ideal zero-thickness rigid faces"],Bc="docs/single-hinge-specification.md",zc=1e-12,Vc="singleHinge",kc={assignment:"valley",angle:1.5707963267948966},Gc={ok:!0,childPoint:[1,0,-1],classification:"certifiedRigidPath"},Hc={schemaVersion:Dc,id:Lc,title:Ic,fixtureClass:Uc,mechanismFamily:Nc,units:Fc,assumptions:Oc,provenance:Bc,tolerance:zc,kind:Vc,input:kc,expected:Gc},Wc=1,Xc="hinge-assignment-invalid",$c="Valley hinge rejects a negative angle",qc="invalid",Yc="single-hinge",Kc="meter-radian",Zc=["Positive angles are valley folds"],Jc="docs/single-hinge-specification.md",Qc=1e-12,jc="singleHinge",eh={assignment:"valley",angle:-.5},th={ok:!1,diagnosticCodes:["KINEMATICS_ANGLE_OUT_OF_RANGE","KINEMATICS_ASSIGNMENT_MISMATCH"]},nh={schemaVersion:Wc,id:Xc,title:$c,fixtureClass:qc,mechanismFamily:Yc,units:Kc,assumptions:Zc,provenance:Jc,tolerance:Qc,kind:jc,input:eh,expected:th},ih=1,sh="vertex-valid-3m1v",rh="Four-crease vertex satisfying Kawasaki and Maekawa",ah="valid",oh="single-vertex",lh="meter-radian",ch=["Interior crease-only vertex"],hh="docs/mathematical-contract.md#37-local-flat-foldability",uh=1e-12,dh="singleVertex",fh={sectorAngles:[1.5707963267948966,1.5707963267948966,1.5707963267948966,1.5707963267948966],assignments:["mountain","mountain","mountain","valley"]},ph={kawasaki:"satisfied",maekawa:"satisfied",locallyFlatFoldable:!0},mh={schemaVersion:ih,id:sh,title:rh,fixtureClass:ah,mechanismFamily:oh,units:lh,assumptions:ch,provenance:hh,tolerance:uh,kind:dh,input:fh,expected:ph},gh=1,_h="vertex-invalid-2m2v",xh="Four-crease vertex failing Maekawa",vh="invalid",Mh="single-vertex",Sh="meter-radian",Eh=["Interior crease-only vertex"],yh="docs/mathematical-contract.md#37-local-flat-foldability",bh=1e-12,Th="singleVertex",Ah={sectorAngles:[1.5707963267948966,1.5707963267948966,1.5707963267948966,1.5707963267948966],assignments:["mountain","valley","mountain","valley"]},wh={kawasaki:"satisfied",maekawa:"failed",locallyFlatFoldable:!1},Rh={schemaVersion:gh,id:_h,title:xh,fixtureClass:vh,mechanismFamily:Mh,units:Sh,assumptions:Eh,provenance:yh,tolerance:bh,kind:Th,input:Ah,expected:wh},Ch=1,Ph="popup-symmetric",Dh="Symmetric axis-aligned two-plane pop-up",Lh="valid",Ih="two-plane-pop-up",Uh="meter-radian",Nh=["Ideal zero-thickness rigid linkage"],Fh="docs/mathematical-contract.md#4-two-plane-pop-up-family",Oh=1e-10,Bh="twoPlanePopUp",zh={id:"popup-symmetric",width:2,height:1,depth:1,deployedAngle:1.5707963267948966,sampleCount:7},Vh={ok:!0,deployedJunction:[0,1,1],axisAligned:!0,classification:"certifiedRigidPath"},kh={schemaVersion:Ch,id:Ph,title:Dh,fixtureClass:Lh,mechanismFamily:Ih,units:Uh,assumptions:Nh,provenance:Fh,tolerance:Oh,kind:Bh,input:zh,expected:Vh},Gh=1,Hh="popup-unequal",Wh="Unequal-link rotated two-plane pop-up",Xh="valid",$h="two-plane-pop-up",qh="meter-radian",Yh=["Unequal links may rotate the child frame"],Kh="docs/mathematical-contract.md#4-two-plane-pop-up-family",Zh=1e-10,Jh="twoPlanePopUp",Qh={id:"popup-unequal",width:2,height:1,depth:2,deployedAngle:1.5707963267948966,sampleCount:7},jh={ok:!0,deployedJunction:[0,.8,1.6],axisAligned:!1,classification:"certifiedRigidPath"},eu={schemaVersion:Gh,id:Hh,title:Wh,fixtureClass:Xh,mechanismFamily:$h,units:qh,assumptions:Yh,provenance:Kh,tolerance:Zh,kind:Jh,input:Qh,expected:jh},tu=1,nu="popup-invalid-width",iu="Two-plane pop-up rejects zero width",su="invalid",ru="two-plane-pop-up",au="meter-radian",ou=["Mechanism dimensions must be positive"],lu="docs/mathematical-contract.md#4-two-plane-pop-up-family",cu=1e-10,hu="twoPlanePopUp",uu={id:"popup-invalid-width",width:0,height:1,depth:1,deployedAngle:1.5707963267948966,sampleCount:7},du={ok:!1,diagnosticCodes:["MECHANISM_POPUP_INVALID_PARAMETER"]},fu={schemaVersion:tu,id:nu,title:iu,fixtureClass:su,mechanismFamily:ru,units:au,assumptions:ou,provenance:lu,tolerance:cu,kind:hu,input:uu,expected:du},pu=1,mu="spatial-root",gu="One root plane pair",_u="valid",xu="nested-parallel-strip",vu="meter-radian",Mu=["Two-level synchronized strip family"],Su="docs/mathematical-contract.md#5-composition-contract",Eu=1e-10,yu="spatialProgram",bu={schemaVersion:1,id:"spatial-root",sheet:{id:"sheet",width:6,wallExtent:3,floorExtent:3,deployedAngle:1.5707963267948966},pathSampleCount:7,operations:[{id:"root",kind:"planePair",target:{kind:"sheet"},xOffset:1,width:2,height:1,depth:1,alignment:"axisAligned",mismatchPolicy:"reject"}]},Tu={ok:!0,classification:"certifiedRigidPath"},Au={schemaVersion:pu,id:mu,title:gu,fixtureClass:_u,mechanismFamily:xu,units:vu,assumptions:Mu,provenance:Su,tolerance:Eu,kind:yu,input:bu,expected:Tu},wu=1,Ru="spatial-nested-shelf",Cu="Root plane pair with nested shelf",Pu="valid",Du="nested-parallel-strip",Lu="meter-radian",Iu=["Two-level synchronized strip family"],Uu="docs/mathematical-contract.md#5-composition-contract",Nu=1e-10,Fu="spatialProgram",Ou={schemaVersion:1,id:"spatial-nested-shelf",sheet:{id:"sheet",width:6,wallExtent:3,floorExtent:3,deployedAngle:1.5707963267948966},pathSampleCount:7,operations:[{id:"root",kind:"planePair",target:{kind:"sheet"},xOffset:1,width:3,height:1.5,depth:1.5,alignment:"axisAligned",mismatchPolicy:"reject"},{id:"shelf",kind:"shelf",target:{kind:"generatedPair",operationId:"root"},xOffset:.5,width:1,height:.5,depth:.5,alignment:"axisAligned",mismatchPolicy:"reject"}]},Bu={ok:!0,classification:"certifiedRigidPath"},zu={schemaVersion:wu,id:Ru,title:Cu,fixtureClass:Pu,mechanismFamily:Du,units:Lu,assumptions:Iu,provenance:Uu,tolerance:Nu,kind:Fu,input:Ou,expected:Bu},Vu=1,ku="spatial-siblings",Gu="Disjoint sibling plane pairs",Hu="valid",Wu="nested-parallel-strip",Xu="meter-radian",$u=["Sibling strip interiors are disjoint"],qu="docs/mathematical-contract.md#5-composition-contract",Yu=1e-10,Ku="spatialProgram",Zu={schemaVersion:1,id:"spatial-siblings",sheet:{id:"sheet",width:6,wallExtent:3,floorExtent:3,deployedAngle:1.5707963267948966},pathSampleCount:7,operations:[{id:"left",kind:"wall",target:{kind:"sheet"},xOffset:0,width:2,height:1,depth:1,alignment:"axisAligned",mismatchPolicy:"reject"},{id:"right",kind:"platform",target:{kind:"sheet"},xOffset:4,width:2,height:1,depth:1,alignment:"axisAligned",mismatchPolicy:"reject"}]},Ju={ok:!0,classification:"certifiedRigidPath"},Qu={schemaVersion:Vu,id:ku,title:Gu,fixtureClass:Hu,mechanismFamily:Wu,units:Xu,assumptions:$u,provenance:qu,tolerance:Yu,kind:Ku,input:Zu,expected:Ju},ju=1,ed="spatial-overlap",td="Overlapping siblings are rejected",nd="invalid",id="nested-parallel-strip",sd="meter-radian",rd=["Sibling strip interiors must be disjoint"],ad="docs/mathematical-contract.md#5-composition-contract",od=1e-10,ld="spatialProgram",cd={schemaVersion:1,id:"spatial-overlap",sheet:{id:"sheet",width:6,wallExtent:3,floorExtent:3,deployedAngle:1.5707963267948966},pathSampleCount:5,operations:[{id:"a",kind:"planePair",target:{kind:"sheet"},xOffset:0,width:2,height:1,depth:1,alignment:"axisAligned",mismatchPolicy:"reject"},{id:"b",kind:"planePair",target:{kind:"sheet"},xOffset:1,width:2,height:1,depth:1,alignment:"axisAligned",mismatchPolicy:"reject"}]},hd={ok:!1,diagnosticCodes:["ASSEMBLY_ATTACHMENT_OVERLAP"]},ud={schemaVersion:ju,id:ed,title:td,fixtureClass:nd,mechanismFamily:id,units:sd,assumptions:rd,provenance:ad,tolerance:od,kind:ld,input:cd,expected:hd},dd=1,fd="spatial-depth-three",pd="Depth-three hierarchy is rejected",md="unsupported",gd="nested-parallel-strip",_d="meter-radian",xd=["Only root and child module levels are supported"],vd="docs/mathematical-contract.md#5-composition-contract",Md=1e-10,Sd="spatialProgram",Ed={schemaVersion:1,id:"spatial-depth-three",sheet:{id:"sheet",width:6,wallExtent:3,floorExtent:3,deployedAngle:1.5707963267948966},pathSampleCount:5,operations:[{id:"root",kind:"planePair",target:{kind:"sheet"},xOffset:0,width:3,height:2,depth:2,alignment:"axisAligned",mismatchPolicy:"reject"},{id:"child",kind:"planePair",target:{kind:"generatedPair",operationId:"root"},xOffset:0,width:2,height:1,depth:1,alignment:"axisAligned",mismatchPolicy:"reject"},{id:"grandchild",kind:"planePair",target:{kind:"generatedPair",operationId:"child"},xOffset:0,width:1,height:.5,depth:.5,alignment:"axisAligned",mismatchPolicy:"reject"}]},yd={ok:!1,diagnosticCodes:["SPATIAL_TARGET_DEPTH_UNSUPPORTED"]},bd={schemaVersion:dd,id:fd,title:pd,fixtureClass:md,mechanismFamily:gd,units:_d,assumptions:xd,provenance:vd,tolerance:Md,kind:Sd,input:Ed,expected:yd},Td=1,Ad="spatial-opening",wd="Opening is explicitly unsupported",Rd="unsupported",Cd="bounded-spatial-compiler",Pd="meter-radian",Dd=["Subtractive topology is not certified"],Ld="docs/mathematical-contract.md#51-bounded-spatial-compilation",Id=1e-10,Ud="spatialProgram",Nd={schemaVersion:1,id:"spatial-opening",sheet:{id:"sheet",width:6,wallExtent:3,floorExtent:3,deployedAngle:1.5707963267948966},pathSampleCount:5,operations:[{id:"door",kind:"opening",target:{kind:"sheet"},xOffset:1,width:2,height:1,depth:1,alignment:"axisAligned",mismatchPolicy:"reject"}]},Fd={ok:!1,diagnosticCodes:["SPATIAL_OPERATION_UNSUPPORTED"]},Od={schemaVersion:Td,id:Ad,title:wd,fixtureClass:Rd,mechanismFamily:Cd,units:Pd,assumptions:Dd,provenance:Ld,tolerance:Id,kind:Ud,input:Nd,expected:Fd},Bd=1,zd="spatial-out-of-bounds",Vd="Attachment outside the sheet is rejected",kd="invalid",Gd="nested-parallel-strip",Hd="meter-radian",Wd=["Attachments must fit their host material"],Xd="docs/mathematical-contract.md#5-composition-contract",$d=1e-10,qd="spatialProgram",Yd={schemaVersion:1,id:"spatial-out-of-bounds",sheet:{id:"sheet",width:6,wallExtent:3,floorExtent:3,deployedAngle:1.5707963267948966},pathSampleCount:5,operations:[{id:"outside",kind:"planePair",target:{kind:"sheet"},xOffset:5,width:2,height:1,depth:1,alignment:"axisAligned",mismatchPolicy:"reject"}]},Kd={ok:!1,diagnosticCodes:["ASSEMBLY_ATTACHMENT_OUT_OF_BOUNDS"]},Zd={schemaVersion:Bd,id:zd,title:Vd,fixtureClass:kd,mechanismFamily:Gd,units:Hd,assumptions:Wd,provenance:Xd,tolerance:$d,kind:qd,input:Yd,expected:Kd},Jd=1;function ul(i){return Qd(i)?{ok:!0,example:i}:{ok:!1,diagnostics:[{severity:"error",category:"evidence",code:"VALIDATION_EXAMPLE_INVALID",message:"Validation examples require schema version 1, metadata, finite tolerance, typed input, and expected output.",entities:[{kind:"validationExample",id:tf(i)}]}]}}function Qd(i){return pi(i)?i.schemaVersion===Jd&&Gn(i.id)&&Gn(i.title)&&["valid","boundary","invalid","unsupported"].includes(String(i.fixtureClass))&&["singleHinge","singleVertex","twoPlanePopUp","spatialProgram"].includes(String(i.kind))&&Gn(i.mechanismFamily)&&i.units==="meter-radian"&&Array.isArray(i.assumptions)&&i.assumptions.every(Gn)&&Gn(i.provenance)&&Number.isFinite(i.tolerance)&&Number(i.tolerance)>=0&&pi(i.input)&&pi(i.expected)&&jd(i):!1}function jd(i){const e=i.input,t=i.expected;return!pi(e)||!pi(t)||typeof t.ok=="string"?!1:i.kind==="singleHinge"?["mountain","valley"].includes(String(e.assignment))&&Number.isFinite(e.angle)&&typeof t.ok=="boolean"&&Za(t.childPoint)&&ks(t.diagnosticCodes):i.kind==="singleVertex"?ef(e.sectorAngles)&&Array.isArray(e.assignments)&&e.assignments.every(n=>["mountain","valley","unassigned"].includes(String(n)))&&e.sectorAngles.length===e.assignments.length&&["satisfied","failed"].includes(String(t.kawasaki))&&["satisfied","failed","notApplicable"].includes(String(t.maekawa))&&typeof t.locallyFlatFoldable=="boolean":i.kind==="twoPlanePopUp"?Gn(e.id)&&[e.width,e.height,e.depth,e.deployedAngle].every(Number.isFinite)&&Number.isInteger(e.sampleCount)&&typeof t.ok=="boolean"&&Za(t.deployedJunction)&&ks(t.diagnosticCodes):i.kind==="spatialProgram"&&typeof t.ok=="boolean"&&ks(t.diagnosticCodes)}function ef(i){return Array.isArray(i)&&i.every(Number.isFinite)}function Za(i){return i===void 0||Array.isArray(i)&&i.length===3&&i.every(Number.isFinite)}function ks(i){return i===void 0||Array.isArray(i)&&i.every(e=>typeof e=="string")}function pi(i){return i!==null&&typeof i=="object"&&!Array.isArray(i)}function Gn(i){return typeof i=="string"&&i.length>0}function tf(i){return pi(i)&&Gn(i.id)?i.id:"unknown"}const nf=Object.assign({"../../examples/validation/01-hinge-flat.json":_c,"../../examples/validation/02-hinge-intermediate.json":Pc,"../../examples/validation/03-hinge-folded.json":Hc,"../../examples/validation/04-hinge-assignment-invalid.json":nh,"../../examples/validation/05-vertex-valid.json":mh,"../../examples/validation/06-vertex-maekawa-invalid.json":Rh,"../../examples/validation/07-popup-symmetric.json":kh,"../../examples/validation/08-popup-unequal.json":eu,"../../examples/validation/09-popup-invalid.json":fu,"../../examples/validation/10-spatial-root.json":Au,"../../examples/validation/11-spatial-nested-shelf.json":zu,"../../examples/validation/12-spatial-siblings.json":Qu,"../../examples/validation/13-spatial-overlap.json":ud,"../../examples/validation/14-spatial-depth.json":bd,"../../examples/validation/15-spatial-opening.json":Od,"../../examples/validation/16-spatial-out-of-bounds.json":Zd}),Gs=Object.entries(nf).sort(([i],[e])=>i.localeCompare(e)).map(([i,e])=>{const t=ul(e);if(!t.ok)throw new TypeError(`${i}: ${t.diagnostics.map(n=>n.message).join(" ")}`);return{filename:i.slice(i.lastIndexOf("/")+1),example:t.example}});function sf(i=new Worker(new URL("/kirigami/assets/engine-worker-CnyJr1Ex.js",import.meta.url),{type:"module",name:"kirigami-engine-lab"})){let e=1,t=!1;const n=new Map,s=r=>{for(const a of n.values())a.reject(r);n.clear()};return i.onmessage=({data:r})=>{if(t||r===null||typeof r!="object"||!Number.isInteger(r.requestId))return;const a=n.get(r.requestId);a&&(n.delete(r.requestId),r.ok?a.resolve(r.subject):a.reject(new Error(r.message)))},i.onerror=r=>{s(new Error(r.message||"Engine worker failed."))},{evaluate(r){if(t)return Promise.reject(new Error("Engine Lab client is disposed."));const a=e;return e+=1,new Promise((o,l)=>{n.set(a,{resolve:o,reject:l}),i.postMessage({requestId:a,type:"evaluate",example:r})})},dispose(){t||(t=!0,s(new Error("Engine Lab client was disposed.")),i.onmessage=null,i.onerror=null,i.terminate())}}}function rf(i){const e=[];return Tr(i.input,["input"],e),e.sort((t,n)=>cf(t.path,n.path))}function af(i,e,t){if(e[0]!=="input"||e.length<2||!Number.isFinite(t)||typeof hf(i,e)!="number")return uf(i.id);const n=Ar(i,e,t);return ul(n)}function Tr(i,e,t){if(typeof i=="number"){const n=String(e[e.length-1]);if(n==="schemaVersion"||n==="tolerance")return;t.push({path:e,label:of(e),value:i,step:n==="sampleCount"||n==="pathSampleCount"?1:n.toLowerCase().includes("angle")?.01:Math.max(Math.abs(i)*.05,.01)});return}if(Array.isArray(i)){i.forEach((n,s)=>Tr(n,[...e,s],t));return}if(!(i===null||typeof i!="object"))for(const n of Object.keys(i).sort())n==="schemaVersion"||n==="tolerance"||Tr(i[n],[...e,n],t)}function of(i){const e=i.slice(1).map(t=>typeof t=="number"?String(t+1):lf(t));return e.slice(Math.max(e.length-3,0)).join(" · ")}function lf(i){const e=i.replace(/([a-z0-9])([A-Z])/g,"$1 $2");return e[0]?.toUpperCase()+e.slice(1)}function cf(i,e){const t=Math.max(i.length,e.length);for(let n=0;n<t;n+=1){const s=i[n],r=e[n];if(s===void 0)return-1;if(r===void 0)return 1;if(s!==r)return typeof s=="number"&&typeof r=="number"?s-r:String(s).localeCompare(String(r))}return 0}function hf(i,e){let t=i;for(const n of e){if(t===null||typeof t!="object")return;t=t[n]}return t}function Ar(i,e,t){if(e.length===0)return t;const[n,...s]=e;if(Array.isArray(i)){const a=[...i];return a[Number(n)]=Ar(a[Number(n)],s,t),a}const r=i;return{...r,[n]:Ar(r[n],s,t)}}function uf(i){return{ok:!1,diagnostics:[{severity:"error",category:"evidence",code:"VALIDATION_EXAMPLE_INVALID",message:"Engine Lab parameter edits require a finite numeric input value.",entities:[{kind:"validationExample",id:i}]}]}}function df(i,e,t,n={}){if(!e){i.innerHTML=t?`<div class="inspector-empty inspector-error">${Ot(t)}</div>`:'<div class="inspector-empty">Select an example to inspect engine evidence.</div>';return}const{result:s}=e,r=rf(e.example);i.innerHTML=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function H_(i,e,t){const n=new Float32Array(Wn),s=new U(0,1,0);return new cn({name:"SphericalGaussianBlur",defines:{n:Wn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Os(),fragmentShader:`
	...
	`}class Wl extends an{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Ol(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Hi(5,5,5),r=new cn({name:"CubemapFromEquirect",uniforms:Ei(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:It,blending:gn});r.uniforms.tEquirect.value=t;const a=new Yt(s,r),o=t.minFilter;return t.minFilter===Xn&&(t.minFilter=Tt),new qp(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}}function W_(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,p=!1){return h==null?null:p?a(h):r(h)}function r(h){if(h&&h.isTexture){const p=h.mapping;if(p===Hs||p===Ws)if(e.has(h)){const x=e.get(h).texture;return o(x,h.mapping)}else{const x=h.image;if(x&&x.height>0){const M=new Wl(x.height);return M.fromEquirectangularTexture(i,h),e.set(h,M),h.addEventListener("dispose",c),o(M.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const p=h.mapping,x=p===Hs||p===Ws,M=p===qn||p===Mi;if(x||M){let m=t.get(h);const u=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==u)return n===null&&(n=new ko(i)),m=x?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{const A=h.image;return x&&A&&A.height>0||M&&A&&l(A)?(n===null&&(n=new ko(i)),m=x?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",d),m.texture):null}}}return h}function o(h,p){return p===Hs?h.mapping=qn:p===Ws&&(h.mapping=Mi),h}function l(h){let p=0;const x=6;for(let M=0;M<x;M++)h[M]!==void 0&&p++;return p===x}function c(h){const p=h.target;p.removeEventListener("dispose",c);const x=e.get(p);x!==void 0&&(e.delete(p),x.dispose())}function d(h){const p=h.target;p.removeEventListener("dispose",d);const x=t.get(p);x!==void 0&&(t.delete(p),x.dispose())}function g(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:g}}function X_(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&_i("WebGLRenderer: "+n+" extension not supported."),s}}}function $_(i,e,t,n){const s={},r=new WeakMap;function a(g){const h=g.target;h.index!==null&&e.remove(h.index);for(const x in h.attributes)e.remove(h.attributes[x]);h.removeEventListener("dispose",a),delete s[h.id];const p=r.get(h);p&&(e.remove(p),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(g,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function l(g){const h=g.attributes;for(const p in h)e.update(h[p],i.ARRAY_BUFFER)}function c(g){const h=[],p=g.index,x=g.attributes.position;let M=0;if(x===void 0)return;if(p!==null){const A=p.array;M=p.version;for(let w=0,S=A.length;w<S;w+=3){const T=A[w+0],b=A[w+1],C=A[w+2];h.push(T,b,b,C,C,T)}}else{const A=x.array;M=x.version;for(let w=0,S=A.length/3-1;w<S;w+=3){const T=w+0,b=w+1,C=w+2;h.push(T,b,b,C,C,T)}}const m=new(x.count>=65535?Ul:Il)(h,1);m.version=M;const u=r.get(g);u&&e.remove(u),r.set(g,m)}function d(g){const h=r.get(g);if(h){const p=g.index;p!==null&&h.version<p.version&&c(g)}else c(g);return r.get(g)}return{get:o,update:l,getWireframeAttribute:d}}function q_(i,e,t){let n;function s(g){n=g}let r,a;function o(g){r=g.type,a=g.bytesPerElement}function l(g,h){i.drawElements(n,h,r,g*a),t.update(h,n,1)}function c(g,h,p){p!==0&&(i.drawElementsInstanced(n,h,r,g*a,p),t.update(h,n,p))}function d(g,h,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,g,0,p);let M=0;for(let m=0;m<p;m++)M+=h[m];t.update(M,n,1)}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=d}function Y_(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:Ge("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function K_(i,e,t){const n=new WeakMap,s=new nt;function r(a,o,l){const c=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,g=d!==void 0?d.length:0;let h=n.get(o);if(h===void 0||h.count!==g){let y=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",y)};h!==void 0&&h.texture.dispose();const p=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,M=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],u=o.morphAttributes.normal||[],A=o.morphAttributes.color||[];let w=0;p===!0&&(w=1),x===!0&&(w=2),M===!0&&(w=3);let S=o.attributes.position.count*w,T=1;S>e.maxTextureSize&&(T=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);const b=new Float32Array(S*T*4*g),C=new Pl(b,S,T,g);C.type=nn,C.needsUpdate=!0;const _=w*4;for(let P=0;P<g;P++){const R=m[P],N=u[P],X=A[P],Y=S*T*4*P;for(let V=0;V<R.count;V++){const $=V*_;p===!0&&(s.fromBufferAttribute(R,V),b[Y+$+0]=s.x,b[Y+$+1]=s.y,b[Y+$+2]=s.z,b[Y+$+3]=0),x===!0&&(s.fromBufferAttribute(N,V),b[Y+$+4]=s.x,b[Y+$+5]=s.y,b[Y+$+6]=s.z,b[Y+$+7]=0),M===!0&&(s.fromBufferAttribute(X,V),b[Y+$+8]=s.x,b[Y+$+9]=s.y,b[Y+$+10]=s.z,b[Y+$+11]=X.itemSize===4?s.w:1)}}h={count:g,texture:C,size:new Ce(S,T)},n.set(o,h),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let p=0;for(let M=0;M<c.length;M++)p+=c[M];const x=o.morphTargetsRelative?1:1-p;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function Z_(i,e,t,n,s){let r=new WeakMap;function a(c){const d=s.render.frame,g=c.geometry,h=e.get(c,g);if(r.get(h)!==d&&(e.update(h),r.set(h,d)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==d&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,d))),c.isSkinnedMesh){const p=c.skeleton;r.get(p)!==d&&(p.update(),r.set(p,d))}return h}function o(){r=new WeakMap}function l(c){const d=c.target;d.removeEventListener("dispose",l),n.releaseStatesOfObject(d),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:o}}const J_={[fl]:"LINEAR_TONE_MAPPING",[pl]:"REINHARD_TONE_MAPPING",[ml]:"CINEON_TONE_MAPPING",[gl]:"ACES_FILMIC_TONE_MAPPING",[xl]:"AGX_TONE_MAPPING",[vl]:"NEUTRAL_TONE_MAPPING",[_l]:"CUSTOM_TONE_MAPPING"};function Q_(i,e,t,n,s,r){const a=new an(e,t,{type:i,depthBuffer:s,stencilBuffer:r,samples:n?4:0,depthTexture:s?new Si(e,t):void 0}),o=new an(e,t,{type:xn,depthBuffer:!1,stencilBuffer:!1}),l=new Pt;l.setAttribute("position",new Ct([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new Ct([0,2,0,0,2,0],2));const c=new Vp({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),d=new Yt(l,c),g=new Ua(-1,1,1,-1,0,1);let h=null,p=null,x=!1,M,m=null,u=[],A=!1;this.setSize=function(w,S){a.setSize(w,S),o.setSize(w,S);for(let T=0;T<u.length;T++){const b=u[T];b.setSize&&b.setSize(w,S)}},this.setEffects=function(w){u=w,A=u.length>0&&u[0].isRenderPass===!0;const S=a.width,T=a.height;for(let b=0;b<u.length;b++){const C=u[b];C.setSize&&C.setSize(S,T)}},this.begin=function(w,S){if(x||w.toneMapping===rn&&u.length===0)return!1;if(m=S,S!==null){const T=S.width,b=S.height;(a.width!==T||a.height!==b)&&this.setSize(T,b)}return A===!1&&w.setRenderTarget(a),M=w.toneMapping,w.toneMapping=rn,!0},this.hasRenderPass=function(){return A},this.end=function(w,S){w.toneMapping=M,x=!0;let T=a,b=o;for(let C=0;C<u.length;C++){const _=u[C];if(_.enabled!==!1&&(_.render(w,b,T,S),_.needsSwap!==!1)){const y=T;T=b,b=y}}if(h!==w.outputColorSpace||p!==w.toneMapping){h=w.outputColorSpace,p=w.toneMapping,c.defines={},ze.getTransfer(h)===qe&&(c.defines.SRGB_TRANSFER="");const C=J_[p];C&&(c.defines[C]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=T.texture,w.setRenderTarget(m),w.render(d,g),m=null,x=!1},this.isCompositing=function(){return x},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),l.dispose(),c.dispose()}}const Xl=new Rt,xa=new Si(1,1),$l=new Pl,ql=new gp,Yl=new Ol,Xo=[],$o=[],qo=new Float32Array(16),Yo=new Float32Array(9),Ko=new Float32Array(4);function Ti(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Xo[s];if(r===void 0&&(r=new Float32Array(s),Xo[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function mt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function gt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Bs(i,e){let t=$o[e];t===void 0&&(t=new Int32Array(e),$o[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function j_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function e0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;i.uniform2fv(this.addr,e),gt(t,e)}}function t0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(mt(t,e))return;i.uniform3fv(this.addr,e),gt(t,e)}}function n0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;i.uniform4fv(this.addr,e),gt(t,e)}}function i0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),gt(t,e)}else{if(mt(t,n))return;Ko.set(n),i.uniformMatrix2fv(this.addr,!1,Ko),gt(t,n)}}function s0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),gt(t,e)}else{if(mt(t,n))return;Yo.set(n),i.uniformMatrix3fv(this.addr,!1,Yo),gt(t,n)}}function r0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),gt(t,e)}else{if(mt(t,n))return;qo.set(n),i.uniformMatrix4fv(this.addr,!1,qo),gt(t,n)}}function a0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function o0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;i.uniform2iv(this.addr,e),gt(t,e)}}function l0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(mt(t,e))return;i.uniform3iv(this.addr,e),gt(t,e)}}function c0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;i.uniform4iv(this.addr,e),gt(t,e)}}function h0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function u0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;i.uniform2uiv(this.addr,e),gt(t,e)}}function d0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(mt(t,e))return;i.uniform3uiv(this.addr,e),gt(t,e)}}function f0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;i.uniform4uiv(this.addr,e),gt(t,e)}}function p0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(xa.compareFunction=t.isReversedDepthBuffer()?Ra:wa,r=xa):r=Xl,t.setTexture2D(e||r,s)}function m0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||ql,s)}function g0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Yl,s)}function _0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||$l,s)}function x0(i){switch(i){case 5126:return j_;case 35664:return e0;case 35665:return t0;case 35666:return n0;case 35674:return i0;case 35675:return s0;case 35676:return r0;case 5124:case 35670:return a0;case 35667:case 35671:return o0;case 35668:case 35672:return l0;case 35669:case 35673:return c0;case 5125:return h0;case 36294:return u0;case 36295:return d0;case 36296:return f0;case 35678:case 36198:case 36298:case 36306:case 35682:return p0;case 35679:case 36299:case 36307:return m0;case 35680:case 36300:case 36308:case 36293:return g0;case 36289:case 36303:case 36311:case 36292:return _0}}function v0(i,e){i.uniform1fv(this.addr,e)}function M0(i,e){const t=Ti(e,this.size,2);i.uniform2fv(this.addr,t)}function S0(i,e){const t=Ti(e,this.size,3);i.uniform3fv(this.addr,t)}function E0(i,e){const t=Ti(e,this.size,4);i.uniform4fv(this.addr,t)}function y0(i,e){const t=Ti(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function b0(i,e){const t=Ti(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function T0(i,e){const t=Ti(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function A0(i,e){i.uniform1iv(this.addr,e)}function w0(i,e){i.uniform2iv(this.addr,e)}function R0(i,e){i.uniform3iv(this.addr,e)}function C0(i,e){i.uniform4iv(this.addr,e)}function P0(i,e){i.uniform1uiv(this.addr,e)}function D0(i,e){i.uniform2uiv(this.addr,e)}function L0(i,e){i.uniform3uiv(this.addr,e)}function I0(i,e){i.uniform4uiv(this.addr,e)}function U0(i,e,t){const n=this.cache,s=e.length,r=Bs(t,s);mt(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=xa:a=Xl;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function N0(i,e,t){const n=this.cache,s=e.length,r=Bs(t,s);mt(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||ql,r[a])}function F0(i,e,t){const n=this.cache,s=e.length,r=Bs(t,s);mt(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Yl,r[a])}function O0(i,e,t){const n=this.cache,s=e.length,r=Bs(t,s);mt(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||$l,r[a])}function B0(i){switch(i){case 5126:return v0;case 35664:return M0;case 35665:return S0;case 35666:return E0;case 35674:return y0;case 35675:return b0;case 35676:return T0;case 5124:case 35670:return A0;case 35667:case 35671:return w0;case 35668:case 35672:return R0;case 35669:case 35673:return C0;case 5125:return P0;case 36294:return D0;case 36295:return L0;case 36296:return I0;case 35678:case 36198:case 36298:case 36306:case 35682:return U0;case 35679:case 36299:case 36307:return N0;case 35680:case 36300:case 36308:case 36293:return F0;case 36289:case 36303:case 36311:case 36292:return O0}}class z0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=x0(t.type)}}class V0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=B0(t.type)}}class k0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Mr=/(\w+)(\])?(\[|\.)?/g;function Zo(i,e){i.seq.push(e),i.map[e.id]=e}function G0(i,e,t){const n=i.name,s=n.length;for(Mr.lastIndex=0;;){const r=Mr.exec(n),a=Mr.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){Zo(t,c===void 0?new z0(o,i,e):new V0(o,i,e));break}else{let g=t.map[o];g===void 0&&(g=new k0(o),Zo(t,g)),t=g}}}class bs{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);G0(o,l,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Jo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const H0=37297;let W0=0;function X0(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Qo=new Pe;function $0(i){ze._getMatrix(Qo,ze.workingColorSpace,i);const e=`mat3( ${Qo.elements.map(t=>t.toFixed(4))} )`;switch(ze.getTransfer(i)){case Cs:return[e,"LinearTransferOETF"];case qe:return[e,"sRGBTransferOETF"];default:return Te("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function jo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+X0(i.getShaderSource(e),o)}else return r}function q0(i,e){const t=$0(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Y0={[fl]:"Linear",[pl]:"Reinhard",[ml]:"Cineon",[gl]:"ACESFilmic",[xl]:"AgX",[vl]:"Neutral",[_l]:"Custom"};function K0(i,e){const t=Y0[e];return t===void 0?(Te("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const _s=new U;function Z0(){ze.getLuminanceCoefficients(_s);const i=_s.x.toFixed(4),e=_s.y.toFixed(4),t=_s.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function J0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ni).join(`
`)}function Q0(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function j0(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Ni(i){return i!==""}function el(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function tl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const ex=/^[ \t]*#include +<([\w\d./]+)>/gm;function va(i){return i.replace(ex,nx)}const tx=new Map;function nx(i,e){let t=Ue[e];if(t===void 0){const n=tx.get(e);if(n!==void 0)t=Ue[n],Te('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return va(t)}const ix=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function nl(i){return i.replace(ix,sx)}function sx(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function il(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const rx={[vs]:"SHADOWMAP_TYPE_PCF",[Ii]:"SHADOWMAP_TYPE_VSM"};function ax(i){return rx[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const ox={[qn]:"ENVMAP_TYPE_CUBE",[Mi]:"ENVMAP_TYPE_CUBE",[Us]:"ENVMAP_TYPE_CUBE_UV"};function lx(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":ox[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const cx={[Mi]:"ENVMAP_MODE_REFRACTION"};function hx(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":cx[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const ux={[dl]:"ENVMAP_BLENDING_MULTIPLY",[Uf]:"ENVMAP_BLENDING_MIX",[Nf]:"ENVMAP_BLENDING_ADD"};function dx(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":ux[i.combine]||"ENVMAP_BLENDING_NONE"}function fx(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function px(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=ax(t),c=lx(t),d=hx(t),g=dx(t),h=fx(t),p=J0(t),x=Q0(r),M=s.createProgram();let m,u,A=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `;const e=kn(i,".example-list"),t=kn(i,".viewport-host"),n=kn(i,".viewport-state"),s=kn(i,".inspector-scroll"),r=kn(i,".timeline-panel input[type='range']"),a=kn(i,".timeline-panel output"),o=kn(i,".timeline-play"),l=[...i.querySelectorAll(".timeline-step")],c=hv(t),d=sf();let g=0,h,p,x,M=0,m;const u=()=>{m!==void 0&&window.clearInterval(m),m=void 0,o.ariaPressed="false",o.textContent="Play"},A=y=>y.points.length+y.segments.length+y.faces.length>0,w=(y,P=!1)=>{if(!h||h.frames.length===0)return;M=Math.max(0,Math.min(y,h.frames.length-1));const R=h.frames[M];c.show(R.frame),P&&c.focus(),r.max=String(h.frames.length-1),r.value=String(M);const N=h.frames.length>1;r.disabled=!N,o.disabled=!N;for(const X of l)X.disabled=!N;a.value=`sample ${M+1}/${h.frames.length} · parameter ${fv(R.parameter)}`},S=y=>{M=0,r.value="0",r.max="0",r.disabled=!0,o.disabled=!0;for(const P of l)P.disabled=!0;a.value=y?"no renderable samples · previous geometry retained":"no engine samples"},T=y=>{n.hidden=y===void 0,n.textContent=y??""},b=y=>{df(s,h,y,{onParameterCommit(P,R){if(!x)return;const N=af(x,P,R);if(!N.ok){b(N.diagnostics[0]?.message);return}x=N.example,C(N.example,{preserveGeometryOnEmpty:!0,focus:!1})},onReset(){p&&(x=p,C(p,{preserveGeometryOnEmpty:!0,focus:!1}))}})},C=async(y,P)=>{u();const R=++g;T(`Evaluating ${y.id}…`);try{const N=await d.evaluate(y);if(R!==g)return;h=N,x=N.example,M=0,b(),N.frames.some(({frame:Y})=>A(Y))?w(0,P.focus):(P.preserveGeometryOnEmpty||(c.show(uv),P.focus&&c.focus()),S(P.preserveGeometryOnEmpty)),T()}catch(N){if(R!==g)return;const X=N instanceof Error?N.message:String(N);b(X),T(`Engine error · ${X}`)}},_=y=>{const P=Gs[y];if(P){for(const[R,N]of[...e.querySelectorAll(".example-row")].entries())N.ariaPressed=String(R===y);p=P.example,x=P.example,C(P.example,{preserveGeometryOnEmpty:!1,focus:!0})}};for(const[y,P]of Gs.entries()){const R=document.createElement("button");R.type="button",R.className="example-row",R.ariaPressed="false",R.innerHTML=`
